    ...
    return (
        ...
        <header className={themeState ? 'light-mode' : 'dark-mode'}>
           ...
           <div className="right-header-container">
                {<button className="create-task" onClick={() => openCreateNewTask()}>+</button>} {/*implement disabled based on if something is open*/}
                <button className="settings" onClick={() => openEditBoard()}>
