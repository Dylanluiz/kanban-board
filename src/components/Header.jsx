...
export default function Header() {
    ...
    const {boards, updateOpenBoard, themeState, switchTheme} = useContext(DataContext)
    ...
    const boardName = boards.map(board => {
      return board.isOpen ? board.name : 'Select a Board' 
    })
    ...
    return (
        ...
        <header className={themeState ? 'light-mode' : 'dark-mode'}>
           <div className="left-header-container">
                ...
                <div className="platform-container">
                    <h2 className={`platform-header ${themeState ? 'light-mode ': 'dark-mode'}`}>{boardName[0]}</h2>
        ...
        <dialog className={`kanban-boards ${themeState ? 'light-mode' : 'dark-mode'}`}>
            ...
            <div className="add-new-table">
                ...
                <h3 className="add-new-table-name">+ Create New Board</h3>
            </div>
